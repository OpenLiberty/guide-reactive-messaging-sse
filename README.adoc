...
endpoint in the parameter. The [hotspot=eventSource file=0]`EventSource` will make a `GET` request to the
...
is successfully receiving messages from the system services and is successfully
