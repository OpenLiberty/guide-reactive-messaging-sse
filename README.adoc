...
To connect to the server, the [hotspot=eventSource file=0]`EventSource` interface
...
See the http://localhost:9084/health[^] URL to confirm that the `bff` microservice is up and running.

Once your application is up and running, open your browser and check out your
service by going to http://localhost:9080[http://localhost:9080]. 
endif::[]
