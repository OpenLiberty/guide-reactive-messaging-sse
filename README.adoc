...
When you visit the URL, you should see something similar to the following webpage:

image::webpage.png[Webpage screenshot, align="center"]

There are three rows in the table, one for each of the running system
