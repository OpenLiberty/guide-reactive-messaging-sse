...
as events to the front-end client that consumes them and displays a table that
contains each system's hostname and its periodically updating load. The
following diagram depicts the application that is used in this guide:
