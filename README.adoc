...
[hotspot=eventSource file=0]`EventSource` interface and specifying the `http://localhost:9084/bff/sse`
URL in the parameter. The [hotspot=eventSource file=0]`EventSource` interface
