...
hostname and current system load. The `frontend` application provides a front-end
...
to the front-end client that consumes the events and displays a table containing
